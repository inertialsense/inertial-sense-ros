...
## NOTICE:  This repository has been ARCHIVED is should NOT be used.  The InertialSense ROS node has moved to [inertial-sense-sdk/ros](https://github.com/inertialsense/inertial-sense-sdk/tree/main/ros).
